...
The hook is used to give the url state and allow it to be accesed freely in react

1. How would you explain form validation to someone who has never programmed before?

Validation ensures the corect information is being inputed and the application is functioning the way it should.

1. In 1-2 sentences, define end to end testing.

End to end testing is where you go through what the user may experience so that way you can fix any bugs or UI issues.
